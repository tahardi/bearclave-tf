...
| [google_compute_instance.bcl_tdx](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_instance) | resource |
...
| <a name="input_machine_type"></a> [machine\_type](#input\_machine\_type) | Machine type (e.g., c3-standard-8) | `string` | `"c3-standard-8"` | no |
